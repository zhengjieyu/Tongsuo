...
static const ERR_STRING_DATA PROV_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_PROV, 0, PROV_R_INCORRECT_PASSWORD),
    "incorrect password"},
    ...
    {ERR_PACK(ERR_LIB_PROV, 0, PROV_R_SMTC_MODULE_CONDITIONAL_ERROR),
    "smtc module conditional error"},
    {ERR_PACK(ERR_LIB_PROV, 0, PROV_R_SMTC_MODULE_ENTERING_ERROR_STATE),
    "smtc module entering error state"},
    {ERR_PACK(ERR_LIB_PROV, 0, PROV_R_SMTC_MODULE_IN_ERROR_STATE),
    "smtc module in error state"},
